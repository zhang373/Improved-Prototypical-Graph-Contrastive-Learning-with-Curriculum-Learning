...
class GNN_pregraph(nn.Module):
    ...
    def forward(self, *argv):
        loader=argv[0]
        print("fine1")
        representTu,the_else = self.gnn.forward(loader)
        #return representTu
        return self.classifier(representTu)
...
def main():
    ...
    # todo: 下游任务在 evaluate_embedding里边，没看明白
    model.to(device)
    #print(model)
    #representTu = model.forward(dataloader_eval)
    #print(representTu)
