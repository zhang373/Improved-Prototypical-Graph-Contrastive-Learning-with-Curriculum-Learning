...
def arg_parse():
    ...
    parser.add_argument('--DS', dest='DS', default='zinc_standard_agent',help='Dataset')
    ...
    parser.add_argument('--lamda1', dest='lamda1', type=float, default=0.7948,
        help='lamda1') # 取值范围设置成[0,1]
    parser.add_argument('--lamda2', dest='lamda2', type=float, default=0.3,
        help='lamda2') # 取值范围设置成[0,1]
    
    parser.add_argument('--info_ent_threshold', dest='info_ent_threshold', type=float, default=4.2497,
        help='info_ent_threshold') # 取值范围为[0,log_2(cluster_num)]，因为cluster_num在运行之前没法知道，因此可以暂时设置成[0,1]之间
    parser.add_argument('--pos_div_threshold', dest='pos_div_threshold', type=float, default=0.8799,
        help='pos_div_threshold') # 选用JS散度时，取值范围为[0,1]
    parser.add_argument('--neg_div_threshold', dest='neg_div_threshold', type=float, default=0.5890,
    ...
    parser.add_argument("--sample_reweighting", type=bool, default=True,
                        help="whether to visualize")
