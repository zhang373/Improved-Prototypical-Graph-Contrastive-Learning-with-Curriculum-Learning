...
def set_args():
    ...
    # 这个要检查一下模型，对一下拷贝的内容
    #
    parser.add_argument('--hidden-dim', dest='hidden_dim', type=int, default=128,    # todo: 不可调参数
                        help='')
    #
    parser.add_argument("--nmb_prototypes", default=15, type=int,
...
def Train(args, num_task, device, dataset_num_features, dataloader, dataloader_eval):
